...
echo -e "\033[1;32m $(fun_trans "INSTALADOR SQUID Mega Center Computacion")"
msg -bar
fun_ip
echo -ne " $(fun_trans "Confirme su ip")\033[1;91m"; read -p ": " -e -i $IP ip
msg -bar
echo -e " $(fun_trans "Ahora elige las Puertas que ESCUCHA  el Squid")"
...
msg -bar
echo -e "\033[1;32m $(fun_trans  "Ahora Escoja Una Config Para Su Proxy")"
msg -bar
