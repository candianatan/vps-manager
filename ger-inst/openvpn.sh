...
clear
msg -bar
echo -e "\033[1;32m     INSTALADOR  OPENVPN"
msg -bar
	# OpenVPN setup and first user creation
echo -e "\033[1;97mEste script necesita ciertos parametros para configurar OpenVPN."
...
#CIPHER
msg -bar
msg -ama " Elija codificacion OPENVPN:"
msg -bar
echo "   1) AES-128-CBC"
echo "   2) AES-192-CBC"
echo "   3) AES-256-CBC"
...
coleta_variaveis () {
echo -e "\033[1;32m     INSTALADOR DE OPENVPN |Mega Center Computacion"
msg -bar
...
msg -bar
echo -e "\033[1;31m Protocolo para las conexiones OPENVPN?"
...
#CIPHER
msg -bar
msg -ama " Codificacion para OPENVPN:"
msg -bar
echo "   1) AES-128-CBC"
echo "   2) AES-192-CBC"
echo "   3) AES-256-CBC"
...
) && echo -e "\033[1;32m [Correcto]" || echo -e "\033[1;31m [FAIL]"
teste_porta () {
msg -bar
  echo -ne " \033[1;31m$(fun_trans ${id} "Verificando"):"
  sleep 1s
  [[ ! $(mportas | grep "$1") ]] && {
    echo -e "\033[1;33m [Fallo]\033[0m"
    } || {
...
msg -bar
msg -ama " Nesecitas crear una SSH para generar el (.ovpn)!"
msg -bar
return 0
}
edit_ovpn_host () {
...
msg -ama " que las configuraciones sean efectuadas"
msg -bar
}
fun_openvpn () {
[[ -e /etc/openvpn/server.conf ]] && {
unset OPENBAR
[[ $(mportas|grep -w "openvpn") ]] && OPENBAR="\033[1;32m ON" || OPENBAR="\033[1;31m OFF"
...
msg -bar
echo -ne "\033[1;97m"
			read -p "QUIERES QUITAR OPENVPN? [Y/N]: " -e REMOVE
msg -bar
